...
<%
    ...
    // 3. VO 방식
    List<VoGoodsMaster> dbData = (List<VoGoodsMaster>) request.getAttribute("listVoGoodsMaster");
%>
...
<main>
        ...
        <div class="row row-col-10 text-center">
            <div class="col-sm-2 d-flex justify-center-end">
                <button class="btn btn-primary btn-sm" id="insert" type="button"
                        onclick="location.href='/base/goods_master_insert'">신규
                </button>
            </div>
            <div class="col-sm-2 d-flex justify-center-end">
                <button class="btn btn-primary btn-sm" id="#2" type="button" onclick="location.href='/base/goods_master_insert'">
                    메뉴2
                </button>
            </div>
            <div class="col-sm-2 d-flex justify-center-end">
                <button class="btn btn-primary btn-sm" id="#3" type="button" onclick="location.href='/base/goods_master_insert'">
                    메뉴3
                </button>
            </div>
            <div class="col-sm-2 d-flex justify-center-end">
                <button class="btn btn-primary btn-sm" id="#4" type="button" onclick="location.href='/base/goods_master_insert'">
                    메뉴4
                </button>
            </div>
            <div class="col-sm-2 d-flex justify-center-end">
                <button class="btn btn-primary btn-sm" id="#5" type="button" onclick="location.href='/base/goods_master_insert'">
                    메뉴5
                </button>
            </div>
        </div>
    ...
    <div class="container text-center py-1 my-1 border-top border-bottom">
        ...
        <% for (VoGoodsMaster VoGoodsMaster : dbData) { %>
        <div class="row row-cols-6 py-2 border-bottom">
            ...
            <div class="col-sm-1"><%=VoGoodsMaster.getKeyId()%>
            </div>
            <div class="col-sm-2"><%=VoGoodsMaster.getStudyDay()%>
            </div>
            <div class="col-sm-5 d-flex justify-content-start"><%=VoGoodsMaster.getContents()%>
            </div>
            <%--  <div class="col"><%=voStudy.getRegDay()%></div>--%>
            <div class="col-sm-2"><%=VoGoodsMaster.getRegDay()%>
            </div>
            <div class="col-sm-1"><a class="btn btn-outline-info btn-sm"
                                     href="/study/study_modify?key_id=<%=VoGoodsMaster.getKeyId()%>">수정</a></div>
            <div class="col-sm-1"><a class="btn btn-outline-dark btn-sm"
                                     href="/study/study_delete?key_id=<%=VoGoodsMaster.getKeyId()%>">삭제</a></div>
