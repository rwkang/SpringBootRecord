    ...
    <form class="pt-3 pb-5" name="frm_study_insert" action="/member/member_inserted" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" readonly class="form-control" id="staticLoginId" name="loginId" value="자동 생성">
            </div>
        </div>
        <div class="row mb-3">
            <label for="staticPassword" class="col-sm-1 ms-5 col-form-label">Password</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="staticPassword" name="password" value="">
            </div>
        </div>
        <div class="row mb-3">
            <label for="inputName" class="col-sm-1 ms-5 col-form-label">성명</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="inputName" name="name" value="">
            </div>
        </div>
        <div class="row mb-3">
            <label for="inputRole" class="col-sm-1 ms-5 col-form-label">권한</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="inputRole" name="role" value="">
            </div>
