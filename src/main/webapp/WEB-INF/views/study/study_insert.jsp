...
<main>
    ...
    <form class="pt-3 pb-5" name="frm_study_insert" action="/study/study_inserted" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="staticStudyDay" name="studyDay" value="">
            </div>
        </div>
        <div class="row mb-3">
            <label for="inputContents" class="col-sm-1 ms-5 col-form-label">Contents </label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="inputContents" name="contents" value="">
            </div>
        </div>
